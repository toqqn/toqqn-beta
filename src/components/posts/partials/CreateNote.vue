<template>
    <div  id="pills-note" role="tabpanel" aria-labelledby="pills-note-tab">
        <form class="wms-form"  @submit.prevent="validateBeforeSubmit" autocomplete="false">
            ...
            <div class="form-group">
                ...
                <textarea name="message" data-vv-name="description" v-model="description" v-validate="'required|min:50|max:500'" class="form-control" id="description" cols="30" rows="6" placeholder="Type in whats in your mind."></textarea>
